...
char a[1003];
int s1(int x1, int y1, int x2, int y2) { return jungle[x2][y2] - jungle[x2][y1-1] - jungle[x1-1][y2] + jungle[x1-1][y1-1]; }
int s2(int x1, int y1, int x2, int y2) { return ocean[x2][y2] - ocean[x2][y1-1] - ocean[x1-1][y2] + ocean[x1-1][y1-1]; }
int s3(int x1, int y1, int x2, int y2) { return ice[x2][y2] - ice[x2][y1-1] - ice[x1-1][y2] + ice[x1-1][y1-1]; }
